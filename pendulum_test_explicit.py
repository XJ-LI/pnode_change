...
parser.add_argument('--pnode_method', type=str, choices=['euler', 'rk2', 'fixed_bosh3', 'rk4', 'dopri5', 'fixed_dopri5', 'beuler', 'cn'], default='dopri5')
...
from pnode import petsc_adjoint_mod  ## edit
...
if __name__ == '__main__':
    ...
    # explicit method for integrator
